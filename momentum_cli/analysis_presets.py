...
DEFAULT_ANALYSIS_PRESETS: Dict[str, AnalysisPreset] = {
    "slow-core": AnalysisPreset(
        key="slow-core",
        name="慢腿·核心监控",
        description="3M-1M / 6M-1M 等权组合，突出核心趋势",
        ...
        trend_window=90,
        rank_lookback=5,
        notes="适用于核心仓监控，剔除近月噪音。",
    ),
    "blend-dual": AnalysisPreset(
        key="blend-dual",
        name="双窗·综合视角",
        description="3M/6M/12M 均剔除近月，兼顾多周期",
        momentum_windows=(63, 126, 252),
        momentum_weights=(0.4, 0.3, 0.3),
        momentum_skip_windows=(21, 21, 21),
        corr_window=60,
        chop_window=14,
        trend_window=60,
        rank_lookback=5,
        notes="用于同时观察多条慢腿，消除近月扰动。",
    ),
    "macro-oversight": AnalysisPreset(
        key="macro-oversight",
        name="宏观长波",
        description="120/240 日组合，剔除近月波动，侧重长周期趋势判断",
        momentum_windows=(120, 240),
        momentum_weights=(0.5, 0.5),
        momentum_skip_windows=(21, 21),
        corr_window=90,
        chop_window=20,
    ...
    "twelve-minus-one": AnalysisPreset(
        ...
        name="12M-1M 长周期",
        description="12 个月动量剔除最近 1 个月，聚焦长期趋势",
